  ...
  en: {
    translation: {
      ...
      insights: {
        ...
        analyze: "Analyze with AI", analyzing: "Analyzing your data...",
        summary: "AI summary", tips: "Personalized tips",
        retry: "Retry analysis", aiError: "Could not analyze right now. Please try again.",
        rateLimit: "Too many requests, please wait a moment.",
        paymentRequired: "AI credits exhausted. Please add credits in workspace settings.",
        disclaimer: "AI guidance only — always confirm with your pediatrician.",
      },
      timeline: {
        title: "Timeline", empty: "Your timeline will appear here",
        addDaily: "Add daily log", newDaily: "New daily log", savedDaily: "Daily log saved",
        sleep: "Sleep h", medication: "Medication",
        report: "Medical report", reportSub: "Export or share with your doctor",
        share: "Share", pdfReady: "PDF generated", shared: "Report shared",
      },
      doctorPortal: {
        title: "Doctor Portal", shareCode: "Doctor share code",
        shareSub: "Show this to your pediatrician for secure access",
        copied: "Code copied", summary: "Health summary",
        records: "Records", fevers: "Fevers", sickDays: "Sick days",
        topSymptoms: "Top symptoms", patient: "Patient", recent: "Recent daily logs",
  ...
  fr: {
    translation: {
      ...
      insights: {
        ...
        analyze: "Analyser avec l'IA", analyzing: "Analyse en cours...",
        summary: "Résumé IA", tips: "Conseils personnalisés",
        retry: "Relancer l'analyse", aiError: "Analyse impossible pour le moment. Réessayez.",
        rateLimit: "Trop de requêtes, patientez un instant.",
        paymentRequired: "Crédits IA épuisés. Ajoutez des crédits dans les paramètres.",
        disclaimer: "Information IA — confirmez toujours avec votre pédiatre.",
      },
      timeline: {
        title: "Suivi quotidien", empty: "Votre historique apparaîtra ici",
        addDaily: "Ajouter un suivi", newDaily: "Nouveau suivi du jour", savedDaily: "Suivi enregistré",
        sleep: "Sommeil h", medication: "Médicament",
        report: "Rapport médical", reportSub: "Exporter ou partager avec votre médecin",
        share: "Partager", pdfReady: "PDF généré", shared: "Rapport partagé",
      },
      doctorPortal: {
        title: "Espace médecin", shareCode: "Code de partage médecin",
        shareSub: "Montrez ce code à votre pédiatre pour un accès sécurisé",
        copied: "Code copié", summary: "Résumé de santé",
        records: "Entrées", fevers: "Fièvres", sickDays: "Jours malade",
        topSymptoms: "Symptômes fréquents", patient: "Patient", recent: "Suivis récents",
  ...
  ar: {
    translation: {
      ...
      insights: {
        ...
        analyze: "تحليل بالذكاء الاصطناعي", analyzing: "جارٍ تحليل بياناتك...",
        summary: "ملخص الذكاء", tips: "نصائح مخصصة",
        retry: "إعادة التحليل", aiError: "تعذّر التحليل الآن. حاول مرة أخرى.",
        rateLimit: "طلبات كثيرة، يرجى الانتظار قليلاً.",
        paymentRequired: "نفدت أرصدة الذكاء الاصطناعي. أضف رصيدًا من الإعدادات.",
        disclaimer: "إرشاد ذكي فقط — استشر طبيب الأطفال دائمًا.",
      },
      timeline: {
        title: "المتابعة اليومية", empty: "سيظهر سجلك هنا",
        addDaily: "إضافة متابعة اليوم", newDaily: "متابعة جديدة", savedDaily: "تم حفظ المتابعة",
        sleep: "ساعات النوم", medication: "الدواء",
        report: "التقرير الطبي", reportSub: "صدّر أو شارك مع الطبيب",
        share: "مشاركة", pdfReady: "تم إنشاء ملف PDF", shared: "تمت مشاركة التقرير",
      },
      doctorPortal: {
        title: "بوابة الطبيب", shareCode: "كود المشاركة مع الطبيب",
        shareSub: "اعرض هذا الكود لطبيب الأطفال للوصول الآمن",
        copied: "تم نسخ الكود", summary: "الملخص الصحي",
        records: "السجلات", fevers: "حالات حمى", sickDays: "أيام المرض",
        topSymptoms: "أبرز الأعراض", patient: "المريض", recent: "آخر السجلات",
